...
import 'package:stackly/features/new_page/new_page_bloc.dart';
...
import 'new_page_widgets/current_package_count.dart';
import 'new_page_widgets/instruction.dart';
import 'new_page_widgets/name_text_field.dart';
import 'new_page_widgets/package_count_row.dart';
import 'new_page_widgets/page_title.dart';
import 'new_page_widgets/save_cancel_row.dart';
import 'new_page_widgets/serving_size.dart';
import 'new_page_widgets/serving_times.dart';
    ...
    return Scaffold(
      body: SafeArea(
        child: Padding(
          ...
          child: BlocConsumer<NewPageBloc,NewPageState>(
